    ...
    public class VolunteerDao
    {
        ...
        public bool Update(Volunteer entity)
        {
            try
            {
                ...
                volunteer.DateOfBirth = entity.DateOfBirth;
                volunteer.PlaceOfBirth = entity.PlaceOfBirth;
        ...
        {
            return db.Volunteers.OrderByDescending(a => a.DateOfBirth).Take(count).ToList();
        }
    }
}
